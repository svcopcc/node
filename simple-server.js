...
app.post('/api/submit', async (req, res) => {
    try {
        ...
        res.json({
            ...
            data: { error_code: "PDF_GENERATION_FAILED", details: error.message }
        });
    }
});
...
const PORT = 3003;
app.listen(PORT, () => {
    console.log(`簡化伺服器運行在 http://localhost:${PORT}`);
    console.log('PDF將儲存到本地，資訊記錄到Google Sheets');
});